    ...
    try {
      ...
      const calculateCreditWorthiness = async () => {
        ...
        const modelRes = await axios
          .post(`http://localhost:8001/recommend`, data)
          .then((res) => {
    ...
    <div className="container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <p>Tax Payment Violations: {panData.taxPaymentViolations}</p>
        ...
        <div className="field-group">
          <label htmlFor="creditWorthinessScore">
            Calculated Credit Worthiness Score:
          </label>
          <input
      ...
      <div className="button-container">
        <a href="/Contract_Portal.html">
          <button>Contract generation portal</button>
        </a>
      </div>
    </div>
  );
